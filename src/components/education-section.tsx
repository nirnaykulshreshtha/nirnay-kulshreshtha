        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          {education.map((edu, index) => (
            ...
            >
              {/* Timeline Dot */}
              <motion.div 
                className={`absolute left-0 top-3.5 flex size-4 items-center justify-center rounded-full bg-gradient-to-br ${edu.typeColor} shadow-lg border-2 border-background transform-gpu [will-change:transform,opacity]`}
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
